...
if (!Array) {
  ...
  (_component_navBar + _component_dropDownCitySelect + _component_dropDown + _component_associationItem + _component_empty + _component_loadMore + _component_layout_tabbar_uni)();
}
