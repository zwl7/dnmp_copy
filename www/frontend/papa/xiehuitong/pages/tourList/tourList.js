...
const tourItem = () => "./components/tourItem.js";
...
const _sfc_main = {
  ...
  data() {
    return {
      topBgImage: "https://cdn-static.papa.com.cn/yuncheng/tour-top-bg.png",
      navBarHeight: 0,
  ...
  onPageScroll(event) {
    ...
    if (scrollTop > 60) {
      this.navColor = "#cff2d6";
      this.customStyle.backgroundColor = "#cff2d6";
    } else {
  ...
  methods: {
    ...
    toDetail(info) {
      common_vendor.index.navigateTo({
        url: `/pages/tourDetail/tourDetail?sport_tourism_id=${info.sport_tourism_id}`
      });
    },
    changeDropDown(res) {
      let obj = {};
    ...
    getList(refresh) {
      return __async(this, null, function* () {
        ...
        this.loading = true;
        let res = yield apis_tour.getTourList(param);
...
if (!Array) {
  ...
  (_component_navBar + _component_dropDown + _component_tourItem + _component_empty + _component_loadMore + _component_layout_default_uni)();
}
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    b: $data.topBgImage,
    c: common_vendor.sr("dropDown", "82360a31-2,82360a31-0"),
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-82360a31"]]);
