...
if (!Array) {
  ...
  (_easycom_uv_input2 + _easycom_uv_form_item2 + _easycom_uv_form2 + _component_bottomButton + _component_layout_default_uni)();
}
...
if (!Math) {
  (_easycom_uv_input + _easycom_uv_form_item + _easycom_uv_form)();
}
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    g: common_vendor.sr("form", "3aa26e01-1,3aa26e01-0"),
    h: common_vendor.p({
      labelPosition: "left",
      model: $data.form,
      labelWidth: "184rpx",
    ...
    i: common_vendor.o($options.handleAdd)
  };
}
