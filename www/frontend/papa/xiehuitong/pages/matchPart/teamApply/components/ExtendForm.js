...
const _sfc_main = {
  ...
  created() {
    ...
    common_vendor.index.$on("teamApplySelectReset", () => {
      this.showTeamInfo = false;
      this.showLeaderInfo = false;
      this.showCoachInfo = false;
  ...
  destroyed() {
    common_vendor.index.$off("teamApplySelect");
    common_vendor.index.$off("teamApplySelectReset");
  }
};
if (!Array) {
