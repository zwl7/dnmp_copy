...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    c: $props.agreementData,
    d: common_vendor.sr("addUserPopup", "410b1211-0"),
    e: common_vendor.p(__spreadProps(__spreadValues({}, _ctx.$attrs), {
      mode: "bottom",
      round: 16
    }))
  };
}
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-410b1211"]]);
