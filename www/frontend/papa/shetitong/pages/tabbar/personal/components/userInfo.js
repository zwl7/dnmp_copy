...
const _sfc_main = {
  ...
  computed: {
    ...
    showLevel() {
      return this.userInfo.is_auth_instructor && this.themeType == 1;
    }
  },
  methods: {
    toEdit() {
...
if (!Array) {
  ...
  (_easycom_uv_avatar2 + _component_LevelIcon + _easycom_uv_tags2 + _easycom_uv_icon2)();
}
...
if (!Math) {
  (_easycom_uv_avatar + _easycom_uv_tags + _easycom_uv_icon)();
}
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    h: common_vendor.f($options.userInfo.tag_ids_arr, (item, index, i0) => {
      return {
        a: "17908de4-2-" + i0,
        b: common_vendor.p({
          text: item.tag_id_str,
          size: "mini",
          type: "success"
        }),
        c: index
    ...
    i: common_vendor.o($options.toEdit),
    j: common_vendor.p({
      name: $data.edit,
      color: "#faac0e",
      size: "30"
