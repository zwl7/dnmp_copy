    ...
    submit() {
      return __async(this, null, function* () {
        this.$refs.formRef.validate().then(() => __async(this, null, function* () {
          ...
          if (params.is_free == 2 && !params.is_free_note) {
            result.push({ message: "请输入场地收费情况说明" });
          }
          if (result.length > 0) {
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    G: common_vendor.o(($event) => $data.form.activity_duration = $event),
    H: common_vendor.p({
      type: "number",
      border: "none",
      placeholder: "请输入时长",
    ...
    I: common_vendor.sr("item1", "17cb9ab9-18,17cb9ab9-1"),
    J: common_vendor.p({
      label: "活动时长(小时)",
      prop: "activity_duration",
      borderBottom: true
    }),
    K: common_vendor.o(($event) => $data.form.join_num = $event),
    L: common_vendor.p({
      border: "none",
      type: "number",
      placeholder: "请输入参与人数",
    ...
    M: common_vendor.sr("item1", "17cb9ab9-20,17cb9ab9-1"),
    N: common_vendor.p({
      label: "参与人数",
      prop: "join_num",
      borderBottom: true
    }),
    O: common_vendor.o(($event) => $data.form.instructor_site_id_str = $event),
    P: common_vendor.p({
      readonly: true,
      disabledColor: "#ffffff",
      placeholder: "请选择活动站点",
    ...
    Q: common_vendor.o((...args) => $options.handleSelectSite && $options.handleSelectSite(...args)),
    R: common_vendor.o($options.handleSelectSite),
    S: common_vendor.p({
      name: "arrow-right",
      color: "#969799"
    }),
    T: common_vendor.sr("item1", "17cb9ab9-22,17cb9ab9-1"),
    U: common_vendor.p({
      label: "活动站点",
    ...
    X: common_vendor.o($options.radioChange),
    Y: common_vendor.o(($event) => $data.form.is_free = $event),
    Z: common_vendor.p({
      modelValue: $data.form.is_free
    }),
    aa: common_vendor.sr("item1", "17cb9ab9-25,17cb9ab9-1"),
    ab: common_vendor.p({
      label: "场地收费情况",
      prop: "is_free",
      borderBottom: false,
    ...
    ac: common_vendor.o(($event) => $data.form.is_free_note = $event),
    ad: common_vendor.p({
      placeholder: "填写场地收费情况（人均X元 或 门票5元/人）",
      modelValue: $data.form.is_free_note
    }),
    ae: $data.form.is_free == 2,
    af: common_vendor.sr("formRef", "17cb9ab9-1,17cb9ab9-0"),
    ag: common_vendor.p({
      labelPosition: "left",
      model: $data.form,
      rules: $data.rules,
    ...
    ah: common_vendor.o($options.handlePickerConfirm),
    ai: common_vendor.o(($event) => $data.showPicker = false),
    aj: common_vendor.o($options.changeHandler),
    ak: common_vendor.p({
    ...
    al: common_vendor.o($options.submit),
    am: common_vendor.p({
      type: "primary",
      text: "提交",
      shape: "circle",
