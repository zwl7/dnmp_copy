  ...
  methods: {
    queryList(pageNo, pageSize) {
      return __async(this, null, function* () {
        ...
        let res = yield api_home_index.getWxNoticeList(params);
        console.log("[ res ] >", res);
        if (res.code == 200) {
...
if (!Array) {
  ...
  (_easycom_z_paging2 + _component_layout_default_uni)();
}
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    c: common_vendor.sr("pagingRef", "9492a016-1,9492a016-0"),
    d: common_vendor.o($options.queryList),
    e: common_vendor.o(($event) => $data.dataList = $event),
    f: common_vendor.p({
      ["auto-height"]: true,
