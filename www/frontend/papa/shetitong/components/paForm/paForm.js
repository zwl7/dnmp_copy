...
const api_base_index = require("../../api/base/index.js");
const components_paForm_paFormProps = require("./paFormProps.js");
const utils_timeUtils = require("../../utils/timeUtils.js");
...
const _sfc_main = {
  ...
  methods: {
    ...
    dateSelectConfirm(e, item) {
      ...
      this.baseModel[item.prop] = utils_timeUtils.formatTimeBase(e.value, "{y}-{m}-{d}");
    },
    // 图片上传
    getFileList(e, item) {
    ...
    changeImageUpload(item) {
      return __async(this, null, function* () {
        ...
        api_base_index.uploadPic({ filePath: file }).then((resp) => {
