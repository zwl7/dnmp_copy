...
const _sfc_main = {
  ...
  computed: {
    ...
    commentIcon() {
      return this.$store.app.currentThemeIconByType["COMMENT_ICON"];
    }
  },
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return common_vendor.e({
    ...
    L: common_vendor.sr("rateRef", "89a62a85-11,89a62a85-9"),
    ...
    S: common_vendor.sr("addUserPopup", "89a62a85-9"),
    T: common_vendor.p({
      mode: "bottom",
      round: 16
    })
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-89a62a85"]]);
