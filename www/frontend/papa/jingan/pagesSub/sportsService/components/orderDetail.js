...
const VisitorViewCommentPopup = () => "../../../pages/tabbar/newHome/components/ServiceStyleItem/components/VisitorViewCommentPopup.js";
const _sfc_main = {
  components: {
    serviceDetailTitle,
  ...
  computed: {
    // 判断是否点单人
    isOrderMan() {
      console.log({ userInfo: this.userStore.userInfo, order: this.order });
      return this.userStore.userInfo.account_id === this.order.creatorId;
    }
  },
  onLoad(options) {
  },
  mounted() {
    this.userStore = store_user_index.useUserStore();
  },
  watch: {
    order: {
      handler(val) {
...
if (!Array) {
  ...
  (_component_serviceDetailTitle + _component_visitor_view_comment_popup)();
}
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    r: common_vendor.sr("visitorViewCommentPopup", "37b3c891-1"),
    s: common_vendor.o($options.handleCommentSubmit),
    t: common_vendor.p({
      initStart: $props.order.rating,
      evaluteMode: $data.evaluteMode
    })
  });
}
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-37b3c891"]]);
