...
const _sfc_main = {
  ...
  computed: {
    ...
    calendarIcon() {
      return "https://cdn-static.papa.com.cn/jxpq/themeStatic/GrassGreen/calendar-date-icon.png";
    }
  },
  methods: {
    goToCurrentMonth() {
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-dd188ee1"]]);
