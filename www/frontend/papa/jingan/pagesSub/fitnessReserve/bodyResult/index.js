...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    e: common_vendor.sr("item1", "0fb23f11-3,0fb23f11-2"),
    f: common_vendor.p({
      prop: "name"
    }),
    g: common_vendor.t($data.form.year),
    h: common_vendor.t($data.form.time),
    i: common_vendor.sr("item1", "0fb23f11-4,0fb23f11-2"),
    j: common_vendor.p({
      prop: "sex"
    }),
    k: common_vendor.sr("formRef", "0fb23f11-2,0fb23f11-0"),
    l: common_vendor.p({
      labelPosition: "left",
      model: $data.form,
      labelWidth: "100",
