  ...
  methods: {
    ...
    getList(refresh) {
      return __async(this, null, function* () {
        ...
        res = yield apis_activity.getUserWxActivityList(param);
        this.getListExtend(res, refresh);
      });
    },
    toDateBallDetail(info) {
      let { activity_id, applicant_id } = info;
      let url = `/pagesSub/activityPart/signUpDetail/index?activity_id=${activity_id}&applicant_id=${applicant_id}&type=activity`;
...
if (!Array) {
  ...
  (_easycom_uv_tabs2 + _easycom_uv_sticky2 + _component_ActivityIndexItem + _component_empty + _component_loadMore + _component_layout_default_uni)();
}
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-9f572cbb"]]);
