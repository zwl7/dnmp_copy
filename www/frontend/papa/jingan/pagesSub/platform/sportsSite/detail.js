  ...
  methods: {
    ...
    getDetail() {
      return __async(this, null, function* () {
        let res = yield apis_common.getWxSiteDetail(this.form);
        if (res.code == 200) {
...
if (!Array) {
  ...
  const _component_paImage = common_vendor.resolveComponent("paImage");
  ...
  (_component_navBar + _component_paImage + _easycom_uv_icon2 + _easycom_uni_icons2 + _component_bottomButton + _easycom_uv_safe_bottom2 + _component_layout_default_uni)();
}
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    b: common_vendor.f($data.info.images_url, (item, index, i0) => {
      return {
        a: "d8729b3b-2-" + i0 + ",d8729b3b-0",
        b: common_vendor.p({
          src: item,
          errorIcon: "https://cdn-static.papa.com.cn/jxpq/themeStatic/GrassGreen/defaultSiteAvater.png"
        }),
        c: common_vendor.o(($event) => $data.previewImage(item), index),
        d: index
      };
    }),
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-d8729b3b"]]);
