  ...
  return {
    a: common_vendor.f($props.list, (item, index, i0) => {
      return {
        ...
        d: index,
        e: common_vendor.o(($event) => $options.clickItem(item, index), index)
      };
    }),
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-e2ca3d8a"]]);
