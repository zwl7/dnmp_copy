  ...
  methods: {
    ...
    handleClickSet() {
      common_vendor.index.navigateTo({
        url: "/pages/matchPart/commonTeam/commonTeam"
      });
      setTimeout(() => {
        this.close();
      }, 100);
    ...
    handleClickAdd() {
      common_vendor.index.navigateTo({
        url: "/pages/matchPart/commonTeamAdd/commonTeamAdd?type=eventApply"
      });
      setTimeout(() => {
        this.close();
      }, 100);
    ...
    handleSubmit() {
      ...
      let userInfo = this.commonTeamList[this.selectedIndex];
      let id_type_map = {
        1: "身份证",
        2: "护照",
        3: "港澳通行证"
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    e: common_vendor.f($data.commonTeamList, (item, index, i0) => {
      return {
        a: common_vendor.o(($event) => $options.handleClickUser(index), index),
        b: "55a43100-3-" + i0 + ",55a43100-0",
        c: common_vendor.p({
          title: item.name,
    ...
    l: common_vendor.sr("popup", "55a43100-0"),
    m: common_vendor.p({
      mode: "bottom",
      round: "16",
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-55a43100"]]);
