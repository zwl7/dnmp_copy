...
if (!Array) {
  ...
  (_component_navBar + _easycom_uv_tabs2 + _component_dropDownCitySelect + _component_dropDown + _easycom_uv_sticky2 + _component_sportTalentItem + _component_empty + _component_loadMore + _component_paBackToTop + _component_layout_default_uni)();
}
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    c: common_vendor.p({
      ...
      activeStyle: {
        color: _ctx.themeTabsActiveColorGetter,
        fontWeight: "610"
      },
      inactiveStyle: {
        color: "#505F79",
    ...
    h: common_vendor.sr("dropDown", "7ebed360-4,7ebed360-1"),
