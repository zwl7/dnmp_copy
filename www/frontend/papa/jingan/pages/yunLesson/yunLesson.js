...
if (!Array) {
  ...
  (_component_navBar + _easycom_uv_tabs2 + _component_yunLessonItem + _component_empty + _component_loadMore + _component_paBackToTop + _component_layout_default_uni)();
}
