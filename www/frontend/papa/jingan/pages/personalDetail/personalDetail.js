...
const pages_personalDetail_index = require("./index.js");
...
const _sfc_main = {
  ...
  data() {
    return {
      default_img: common_assets.defaultAvatar,
      marginTop: "",
      rules: pages_personalDetail_index.rules,
      form: {
        name: "",
        avatar: "",
        phone: "",
  ...
  methods: {
    ...
    replaceAvatar() {
      return __async(this, null, function* () {
        const res = yield utils_util.chooseImage("canvas");
        if (res.status) {
...
if (!Array) {
  ...
  (_component_navBar + _easycom_uv_icon2 + _easycom_uv_form_item2 + _easycom_uv_input2 + _easycom_uv_form2 + _component_bottomButton + _component_layout_default_uni)();
}
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    f: common_vendor.sr("item1", "42bebfdd-3,42bebfdd-2"),
    g: common_vendor.p({
      label: "头像",
      prop: "avatar",
      borderBottom: true
    ...
    k: common_vendor.sr("item1", "42bebfdd-5,42bebfdd-2"),
    l: common_vendor.p({
      label: "昵称",
      prop: "nick_name",
      borderBottom: true
    ...
    n: common_vendor.sr("item1", "42bebfdd-8,42bebfdd-2"),
    o: common_vendor.p({
      label: "手机号",
      prop: "phone",
      borderBottom: true
    ...
    t: common_vendor.sr("item1", "42bebfdd-9,42bebfdd-2"),
    v: common_vendor.p({
      label: "实名认证",
      prop: "guide",
      borderBottom: true
    }),
    w: common_vendor.sr("formRef", "42bebfdd-2,42bebfdd-0"),
    x: common_vendor.p({
      labelPosition: "left",
      model: $data.form,
      rules: $data.rules,
    ...
    z: $data.marginTop + "rpx"
  });
}
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-42bebfdd"]]);
