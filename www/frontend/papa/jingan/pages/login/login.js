...
const _sfc_main = {
  ...
  onLoad() {
    return __async(this, null, function* () {
      this.logoImg = config_config.config.logoImg;
      console.log({ logoImg: this.logoImg });
      console.log({ config: config_config.config });
    });
  },
  onShow() {
    return __async(this, null, function* () {
  ...
  methods: {
    fnRequest(info) {
      return __async(this, null, function* () {
        ...
        app.globalData.userInfo.auth = res.data.auth;
    ...
    toAgreement(type) {
      ...
      if (type == 1) {
        common_vendor.index.navigateTo({
          url: "/pagesSub/system/agreement/agreement"
        });
      }
      if (type == 2) {
        common_vendor.index.navigateTo({
          url: "/pagesSub/system/privacy/privacy"
        });
      }
    },
