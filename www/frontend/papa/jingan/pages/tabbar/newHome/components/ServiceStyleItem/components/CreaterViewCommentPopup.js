...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    a: common_vendor.sr("rateRef", "e0ba5a1d-1,e0ba5a1d-0"),
    b: common_vendor.p({
      count: $data.count,
    ...
    f: common_vendor.sr("rateRef", "e0ba5a1d-3,e0ba5a1d-0"),
    g: common_vendor.p({
      count: $data.count,
    ...
    m: $data.activeTab === 1,
    n: common_vendor.sr("myCenterPopue", "e0ba5a1d-0"),
    o: common_vendor.p({
      title: "满意度评价",
      customStyle: {}
    })
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-e0ba5a1d"]]);
