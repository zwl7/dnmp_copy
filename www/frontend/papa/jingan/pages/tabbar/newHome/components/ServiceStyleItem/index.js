...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    A: common_vendor.sr("visitorViewCommentPopup", "e7e3d2b3-6"),
    B: common_vendor.o($options.handleCommentSubmit),
    C: common_vendor.p({
      evaluteMode: $data.evaluteMode,
      initStart: $props.item.rating
    }),
    D: common_vendor.sr("createrViewCommentPopup", "e7e3d2b3-7"),
    E: common_vendor.p({
      ratingObj: $data.ratingObj
    })
  });
}
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-e7e3d2b3"]]);
