...
const pages_tabbar_newHome_extend = require("../newHome/extend.js");
  ...
  methods: {
    getData() {
      return __async(this, null, function* () {
        this.loading = true;
        yield pages_tabbar_newHome_extend.getWxNoticeList.call(this);
        yield pages_tabbar_newHome_extend.getWxRecommendList.call(this);
        yield pages_tabbar_newHome_extend.getWxNoticeList.call(this);
        this.loading = false;
        this.showNoticeList = this.noticeList;
        yield pages_tabbar_newHome_extend.getNewsTypeList.call(this);
        yield pages_tabbar_newHome_extend.getOrganizationType.call(this);
        yield pages_tabbar_newHome_extend.getOrganizationList.call(this);
        yield pages_tabbar_newHome_extend.getRecommendAreaTypeList.call(this);
        yield pages_tabbar_newHome_extend.getNewsRecommendList.call(this);
      });
    },
    clickSwiper(item) {
    ...
    clickInfoTab(item) {
      ...
      pages_tabbar_newHome_extend.getNewsRecommendList.call(this);
    },
    // 体育组织标签点击
    clickOrgTab(item) {
      this.organizationSiteType = item.value;
      pages_tabbar_newHome_extend.getOrganizationList.call(this);
    },
    //滚动卡片点击
