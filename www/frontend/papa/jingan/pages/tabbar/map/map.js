...
const mapTouchTitle = () => "./components/mapTouchTitle.js";
const mapTouch = () => "../../../components/mapTouch.js";
const mapItem = () => "./components/mapItem.js";
const _sfc_main = {
  ...
  computed: {
    mapTouchTitle() {
      var _a;
      return ((_a = this.tabList.find((item) => item.gather_type_id === this.sizer.gather_type_id)) == null ? void 0 : _a.name) || "全部类型";
    }
  },
  onReady() {
    return __async(this, null, function* () {
      ...
      if (app.globalData.user_latitude && app.globalData.user_longitude) {
        ...
        utils_util.reverseGeocoder(user_latitude, user_longitude).then((res) => {
  ...
  methods: {
    ...
    regionchange(res) {
      if (res.type === "end") {
        ...
        let distance = utils_util.getShortDistanceBase(
          new_latitude,
          new_longitude,
    ...
    handleRight(type) {
      ...
      if (type == 3) {
        let urlList = {
          '[{"type_id":3,"small_type_id":0}]': "/pagesSub/platform/stadium/index",
          '[{"type_id":1,"small_type_id":10}]': "/pagesSub/platform/sportsSite/index",
          '[{"type_id":1,"small_type_id":8}]': "/pagesSub/platform/sportsOrg/index"
        };
        let url = urlList[this.currentGatherInfo];
        if (url) {
    ...
    handleClickListItem(item) {
      console.log(item);
      item.showImage = item.images;
      this.mapInfo = item;
      this.$nextTick(() => {
        this.$refs["showMapInfoPopupRef"].open();
      });
    },
...
体育资源点`,
    ...
    getRegion() {
      ...
      this._mapContext.getRegion({
        success(res) {
          ...
          const radium = utils_util.getShortDistanceBase(
            lat_1,
            lon_1,
    ...
    changeTab(e) {
      ...
      this.currentGatherInfo = e.gather_info;
      this.getSearchData();
    }
  }
};
if (!Array) {
  ...
  const _component_mapTouchTitle = common_vendor.resolveComponent("mapTouchTitle");
  ...
  (_component_navBar + _component_scrollTabX + _component_show_map_info_popup + _component_mapTouchTitle + _component_mapItem + _component_empty + _component_mapTouch + _component_layout_tabbar_uni)();
}
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    j: $data.currentGatherInfo
  }, $data.currentGatherInfo ? {
    k: common_assets._imports_2,
    l: common_vendor.o(($event) => $options.handleRight(3))
  } : {}, {
    m: $data.latitude,
    n: $data.longitude,
    o: $data.scale,
    p: $data.overlooking,
    q: $data.skew,
    r: common_vendor.o((...args) => $options.regionchange && $options.regionchange(...args)),
    s: common_vendor.o((...args) => $options.clickMarker && $options.clickMarker(...args)),
    t: common_vendor.o((...args) => $options.clickMarker && $options.clickMarker(...args)),
    v: common_vendor.sr("showMapInfoPopupRef", "e421459e-3,e421459e-0"),
    w: common_vendor.p({
      mapInfo: $data.mapInfo
    }),
    x: common_vendor.p({
      title: $options.mapTouchTitle,
      total: $data.listTotal
    }),
    y: common_vendor.f($data.mapList, (item, index, i0) => {
      return {
        a: common_vendor.o(($event) => $options.handleClickListItem(item), index),
        b: "e421459e-6-" + i0 + ",e421459e-4",
        c: common_vendor.p({
          info: item
        }),
        d: index
    ...
    z: $data.mapList.length == 0
  }, $data.mapList.length == 0 ? {} : {});
}
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-e421459e"]]);
