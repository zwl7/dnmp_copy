...
if (!Array) {
  ...
  (_component_recomendSwiper + _easycom_uni_icons2 + _component_dropDown + _component_ActivityIndexItem + _component_empty + _component_loadMore + _component_paBackToTop + _component_layout_tabbar_uni)();
}
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    i: common_vendor.sr("dropDown", "9b7d777e-3,9b7d777e-0"),
