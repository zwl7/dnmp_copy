...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    k: common_vendor.t($options.swiperName),
    l: $props.list.length != 1
  }, $props.list.length != 1 ? {
    m: common_vendor.f($props.list.length, (item, index, i0) => {
      return {
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-924bf3e1"]]);
