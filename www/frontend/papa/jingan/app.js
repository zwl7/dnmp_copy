...
if (!Math) {
  ...
  "./pagesSub/sportsService/serviceStyle/index.js";
  "./pagesSub/sportsService/serviceStyle/myStyle.js";
  "./pagesSub/sportsService/serviceStyle/orderStyle.js";
  "./pagesSub/sportsService/serviceStyle/detail.js";
  "./pagesSub/sportsService/serviceStyle/form.js";
  "./pagesSub/sportsService/sprotOrder/index.js";
  "./pagesSub/sportsService/sprotOrder/form.js";
  "./pagesSub/sportsService/sprotOrder/detail.js";
  "./pagesSub/sportsService/serviceUndertake/index.js";
  "./pagesSub/sportsService/serviceUndertake/form.js";
  "./pagesSub/sportsService/serviceAssign/index.js";
  "./pagesSub/sportsService/serviceAssign/organList.js";
  "./pagesSub/sportsService/serviceAssign/talenList.js";
  "./pagesSub/sportsService/serviceAssign/detail.js";
  "./pagesSub/sportsService/serviceComment/index.js";
  "./pagesSub/sportsService/personalDetail/personalDetail.js";
  "./pagesSub/sportsService/realAuth/index.js";
  "./pagesSub/sportsService/realAuth/realAtuthSubmit.js";
  "./pagesSub/sportsService/realAuth/myIdentity.js";
  "./pagesSub/sportsService/dataOverview/index.js";
  ...
  "./pagesSub/activityPart/activityIndex/index.js";
  "./pagesSub/activityPart/detail/index.js";
  "./pagesSub/activityPart/apply/index.js";
  "./pagesSub/activityPart/apply/result.js";
  "./pagesSub/activityPart/signUpDetail/index.js";
  "./pagesSub/activityPart/myApply/index.js";
  "./pagesSub/platform/search/search.js";
  "./pagesSub/platform/sportsOrg/index.js";
  "./pagesSub/platform/sportsOrg/detail.js";
  "./pagesSub/platform/sportsSite/index.js";
  "./pagesSub/platform/sportsSite/detail.js";
  "./pagesSub/platform/stadium/index.js";
  "./pagesSub/platform/stadium/detail.js";
  "./pagesSub/platform/yunLesson/index.js";
  "./pagesSub/platform/yunLesson/detail.js";
  "./pagesSub/platform/notice/index.js";
  "./pagesSub/platform/notice/detail.js";
  "./pagesSub/system/setting/index.js";
  "./pagesSub/system/agreement/agreement.js";
  "./pagesSub/system/privacy/privacy.js";
}
const _sfc_main = {
  globalData: {
    isAuth: false,
  ...
  onLaunch: function(e) {
    ...
    common_vendor.index.loadFontFace({
      ...
      // 自定义字体名称（如：'MyCustomFont'）
      source: [
        `url('https://cdn-static.papa.com.cn/ppcs_mp/YouSheBiaoTiHei-2.ttf') format('woff')`
      ].join(","),
      global: true,
      // 全局生效
      success() {
  ...
  methods: {
    // 基础设置
    setBaseConfig() {
      common_vendor.index.$log.info("baseConfig", config_config.config);
      this.globalData.company_id = config_config.config.company_id;
    },
    // 菜单按钮的布局位置信息
    getNavBarInfo() {
...
const paImage = () => "./components/paImage/index.js";
...
function createApp() {
  ...
  app.component("centerPopue", centerPopue);
  app.component("paTag", paTag);
  app.component("paImage", paImage);
  app.component("paBackToTop", paBackToTop);
  app.use(common_vendor.uvUi);
  app.use(store_index.store);
  mixins_appMount.install(app);
