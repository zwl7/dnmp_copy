...
const _sfc_main = {
  ...
  computed: {
    themeConfig() {
      console.log(this.$store.app.themeConfig);
  ...
  methods: {
    ...
    getNoticeList() {
      return __async(this, null, function* () {
        let res = yield apis_home_index.getWxNoticeRecommendList({ mp_type: "socialSports" });
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    c: common_vendor.p({
      ...
      bgColor: $options.themeConfig["--hubei-primary-light2"],
      mode: "link",
      url: "/pages-sub/notice/index"
    })
  };
}
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-aded5f58"]]);
