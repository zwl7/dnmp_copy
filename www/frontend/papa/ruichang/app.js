...
if (!Math) {
  ...
  "./pages-sub/selectOrganization/index.js";
  ...
  "./pages-sub/instructorRegion/index.js";
  "./pages-sub/sportsOrg/index.js";
  "./pages-sub/sportsOrg/detail.js";
  "./pages-sub/map/index.js";
  "./pages-sub/sportOrder/index.js";
  "./pages-sub/sportOrder/form.js";
  "./pages-sub/sportOrder/detail.js";
...
function createApp() {
  ...
  app.use(mixins_appMount.install);
  app.use(apis_index.api);
  ...
  app.component("appMount", mixins_appMount.install);
