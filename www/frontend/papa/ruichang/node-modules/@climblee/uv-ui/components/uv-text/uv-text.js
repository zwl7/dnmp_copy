...
const _sfc_main = {
  name: "uv-text",
  emits: ["click"],
  mixins: [common_vendor.mpMixin, common_vendor.mixin, common_vendor.value, common_vendor.button, common_vendor.openType, common_vendor.props$32],
  computed: {
    valueStyle() {
      const style = {
...
//# sourceMappingURL=uv-text.js.map
