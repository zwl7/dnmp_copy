  ...
  methods: {
    ...
    getList(refresh = false) {
      return __async(this, null, function* () {
        ...
        const res = yield apis_sportsService_serviceAssign.getTalentOrderList(param);
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    d: $data.formSearch.serveWorkDevStatus !== "serve_wait"
  }, $data.formSearch.serveWorkDevStatus !== "serve_wait" ? {
    e: common_vendor.o($options.hanldeSearch),
    f: common_vendor.p({
    ...
    g: common_vendor.f(_ctx.list, (item, index, i0) => {
      return {
        ...
        d: common_vendor.o($options.handlePublishStyle, index + "orderItem"),
        e: "38ab95b8-4-" + i0 + ",38ab95b8-0",
        f: common_vendor.p({
          item,
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-38ab95b8"]]);
wx.createPage(MiniProgramPage);
//# sourceMappingURL=talenList.js.map
