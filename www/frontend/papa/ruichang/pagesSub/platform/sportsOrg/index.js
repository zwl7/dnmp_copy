...
const _sfc_main = {
  ...
  methods: {
    ...
    citySelectConfirm(e) {
      ...
      this.searchParams["belong_place_id"] = values.length ? values[values.length - 1] : "";
      this.resetData();
      this.$refs["dropDown"].close();
    },
    citySelectReset() {
...
if (!Array) {
  ...
  (_component_navBar + _component_dropDownCitySelect + _component_dropDown + _component_associationItem + _component_empty + _component_loadMore + _component_paBackToTop + _component_layout_default_uni)();
}
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    g: common_vendor.sr("dropDown", "fc14c723-2,fc14c723-0"),
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-fc14c723"]]);
