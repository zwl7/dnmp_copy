...
const _sfc_main = {
  ...
  created() {
    getApp();
    let { menuRight, menuTop, navBarHeight, menuHeight, menuWidth } = this.$store.app.menuInfo;
    console.log(this.$store.app.menuInfo);
  ...
  methods: {
    handleSearch() {
      common_vendor.index.navigateTo({
        url: "/pages/search/search?module=" + this.moduleKey
      });
    },
    handleBack() {
