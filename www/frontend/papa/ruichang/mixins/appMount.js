...
function autoLoading(promise, delay = 200, duration = 350) {
  return __async(this, null, function* () {
    var _a;
    let res = yield Promise.race([promise, sleepFunction(delay)]);
    if (!((_a = res == null ? void 0 : res.includes) == null ? void 0 : _a.call(res, "sleep"))) {
      return res;
    }
    common_vendor.index.showLoading({ title: "加载中" });
    let [result] = yield Promise.all([promise, sleepFunction(duration)]);
...
//# sourceMappingURL=appMount.js.map
