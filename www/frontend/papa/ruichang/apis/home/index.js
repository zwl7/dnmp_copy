...
const getStadiumList = (data) => utils_http.request({ url: "/infoPlatform/wxStadium/list", data, method: "POST" });
const getSportsOrgList = (data) => utils_http.request({ url: "/infoPlatform/wxSite/list", data, method: "POST" });
...
exports.getSportsOrgList = getSportsOrgList;
exports.getStadiumList = getStadiumList;
exports.getWxInstructorList = getWxInstructorList;
