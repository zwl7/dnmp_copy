...
const _sfc_main = {
  ...
  data() {
    return {
      ...
      appStore: store_app_index.useAppStore(),
      rules: {
        dictName: {
          required: true,
          trigger: ["change"],
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    b: common_vendor.t($data.appStore.userInfo.nick_name || "--"),
    c: common_vendor.p({
      label: "联系人",
      prop: "contact",
      borderBottom: true
    }),
    d: common_vendor.t($data.appStore.userInfo.phone || "--"),
    e: common_vendor.p({
      label: "手机号",
      prop: "phone"
    }),
    ...
    I: common_vendor.sr("formRef", "5b0f3f86-2,5b0f3f86-0"),
    J: common_vendor.p({
      model: $data.form,
      rules: $data.rules,
      ["label-width"]: "200rpx",
    ...
    L: common_vendor.sr("typeSelect", "5b0f3f86-25,5b0f3f86-0"),
    ...
    O: common_vendor.sr("startTmePicker", "5b0f3f86-26,5b0f3f86-0"),
    ...
    S: common_vendor.sr("endTimePicker", "5b0f3f86-27,5b0f3f86-0"),
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-5b0f3f86"]]);
