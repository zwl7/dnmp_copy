...
const _sfc_main = {
  ...
  methods: {
    confirm() {
      ...
      common_vendor.index.$emit("PUBLISH_SELECT_SITE", tagObj);
    ...
    getData() {
      return __async(this, null, function* () {
        let res = yield this.$api.getInstructorSiteList({ page: 1, size: 999, status: 2 });
  ...
  return {
    ...
    e: common_vendor.f($data.tempList, (item, index, i0) => {
      return common_vendor.e({
        ...
        e: "2bee5bcc-5-" + i0 + "," + ("2bee5bcc-4-" + i0),
        f: common_vendor.p({
          title: item.label
        }),
        g: index,
        h: "2bee5bcc-4-" + i0 + ",2bee5bcc-3"
      });
    }),
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-2bee5bcc"]]);
