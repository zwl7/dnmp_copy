...
const _sfc_main = {
  ...
  methods: {
    handle() {
      ...
      if (site_id) {
        path = "/pages/associationDetail/associationDetail?site_id=" + site_id;
      }
      if (!path) {
        return;
      }
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-7e38dc0e"], ["__file", "E:/gxm/uniapp-shandong/pages/search/components/searchItem.vue"]]);
