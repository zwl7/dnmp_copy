...
const _sfc_main = {
  ...
  onLoad(options) {
    ...
    this.share = {
      title: "",
      path: "/pages/activityDetail/activityDetail?stadium_id" + this.stadium_id,
      withShareTicket: true
    };
  },
  methods: {
    async getWxStadiumDetail() {
      let params = {
        stadium_id: this.stadium_id
      };
      let res = await apis_stadium.getWxStadium(params);
      if (res.code === 200) {
    ...
    collect: utils_buttonClick.debounce(async function() {
      ...
      let params = {
        type_id: 3,
        topic_id: this.activityInfo.stadium_id,
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-285c8c73"], ["__file", "E:/gxm/uniapp-shandong/pages/stadiumDetail/stadiumDetail.vue"]]);
